...
//
interface SafariDetailsProps {
  sub_category_id: string;
  tour_id: string;
}

const SafariDetails: React.FC<SafariDetailsProps> = ({
  sub_category_id,
  tour_id,
}) => {
  const {
    ...
    error,
    loading,
  } = useTourPackageData("tours/" + tour_id);
